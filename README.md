...
The experimental data is taken from [1].
...
As a result of model training, it was possible to achieve higher accuracy compared to the author of the dissertation [1], who used a classical kinetic model. 
...
=====Literature=====     
[1] Jansen G. Acosta-López. Fluid Catalytic Cracking (FCC) Riser Operation: Integrating Experiments, Computational Fluid Dynamics, and Machine Learning Models. The University of Western Ontario. 2025
